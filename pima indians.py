...
scaler_validation = StandardScaler().fit(X_validation)
rescaledX_val = scaler_validation.transform(X_validation)
...
i = 0
for item in [X_train,rescaledX]:

    if i == 0:
        print
        print 'currently working with raw training data'
        i+=1
    else:
        print
        print 'currently working with rescale data (mean of 0 std 1)'
